# @synopsis AC_CHECK_LIBTIFF
#
# Tests for presence of TIFF library. If libtiff has been found, 
# `HAVE_LIBTIFF' will be defined. If the libtiff requires additional
# libraries (usualy zlib for deflate and libjpeg for JPEG compression),
# they will be added to LIBS.
#
# The test also checks the presence of different codecs in libtiff:
# HAVE_TIFFINITZIP tells deflate codec has been compiled in,
# HAVE_TIFFINITJPEG tells JPEG codec has been compiled in,
# HAVE_TIFFINITSGILOG tells SGI logLuv codec has been compuiled in,
# HAVE_TIFFLZWENCODER tells the LZW encoder is present.
#
# @version $Id$
# @author Jan Prikryl <prikryl@acm.org>
#
# Modifications and addition by Yaser Afshar (afshar@mpi-cbg.de)
